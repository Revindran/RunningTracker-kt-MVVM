...
public abstract class Hilt_SetUpFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_SetUpFragment(@LayoutRes int contentLayoutId) {
  ...
  protected void inject() {
    ((SetUpFragment_GeneratedInjector) generatedComponent()).injectSetUpFragment(UnsafeCasts.<SetUpFragment>unsafeCast(this));
  }
